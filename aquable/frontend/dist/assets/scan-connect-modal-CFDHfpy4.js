const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-DFOxvOhe.js","./wattage-calculator-aI2XEFfd.js","./main-DnboNkDH.css"])))=>i.map(i=>d[i]);
import{s as l,c as v,u as o,_ as u}from"./main-DFOxvOhe.js";import"./wattage-calculator-aI2XEFfd.js";async function S(){const e=document.createElement("div");e.className="modal-overlay",e.innerHTML=`
